...
public class SelectMusicControllerUpd implements Initializable {
	...
	public UpdateRecommendAlbumController urac;
	
	public void setcontroller(UpdateRecommendAlbumController urac) {
		this.urac = urac;
	}
